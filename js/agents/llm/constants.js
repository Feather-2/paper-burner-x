...
export function isValidModelUsage(value) {
  return typeof value === "string" && (/** @type {string[]} */ (Object.values(ModelUsage))).includes(value);
}
...
export function isValidMessageRole(value) {
  return typeof value === "string" && (/** @type {string[]} */ (Object.values(MessageRole))).includes(value);
}
...
export function isValidModelHealth(value) {
  return typeof value === "string" && (/** @type {string[]} */ (Object.values(ModelHealth))).includes(value);
}
...
export function isValidRouterStrategy(value) {
  return typeof value === "string" && VALID_ROUTER_STRATEGIES.has(value);
}
