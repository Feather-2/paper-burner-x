...
function createBlockedWorkerModuleUrlError(moduleUrl, reason) {
...
function resolveAndValidateWorkerModuleUrl(moduleUrl, { isNode, policy, allowedOrigins, baseUrl }) {
