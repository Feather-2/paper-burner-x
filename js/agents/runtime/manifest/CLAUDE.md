...
- 提供 create*Manifest 工厂函数与参数 Schema 归一化
...
| `ManifestSchema` | 清单结构 (名称/版本/权限/Schema/metadata/input/output/dependencies/config) |
| `extractManifestFromTool/Skill` | 从定义/元数据提取 Manifest 并推断权限 |
